...
<script>
//$( "select#makes").click(function() {
//  $( "#makes option" ).attr("selected","selected").addClass("selected");
//});
	
	//closer
$("#makes > option").each(function() {
	  $("#makes > option").click(function() {
		  if ($("#makes > option").attr("selected")) {
			  $("#makes > option").removeAttr("selected");
		  } else {
			  $("#makes > option").attr("selected", "selected");
		  }
		  //$(this).attr("selected","selected").addClass("selected");
		  //if (typeof attr === "selected") {
...
$(document).ready(function(){
    $('#makes input[type="radio"]').on("click", function(){
        ...
        var inputVal = $(this).val(); //needs to be an array
        if(inputVal.length){
            $.get("../backend-search.php", {term: inputVal}).done(function(data){
				$("#models").html(data);
				//$.each(data, function(){
			   //$("#models").append('<option value="'+ this.value +'">'+ this.name +'</option>')
			   //})
            });
        } else{
    ...
    $(document).on("click", "#models option", function(){
        $(this).parents("#makes").find('input[type="radio"]').val($(this).text());
...
<script>
	...
	//var name = $("#makes input[type=checkbox]").attr("name");
//	$.get("../updateTypes.php?q="+name, function(data) {
//    $("#models option").remove();
//    $.each(data, function(){
//        $("#models option").append('<option value="'+ this.value +'">'+ this.name +'</option>')
//    })
//});
</script>
</html>
